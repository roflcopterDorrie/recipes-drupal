 ...
 * @endcode
 */
$settings['hash_salt'] = getenv('DRUPAL_HASH_SALT') ?: 'temporary-salt-change-me-in-prod';
...
// 2. DDEV-Specific Settings (Only runs on your local machine)
...
// 3. Local Overrides (Optional - for things you don't want in Git)
